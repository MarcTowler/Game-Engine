...
namespace GameEngine
{
    public class Character : GameObject
    {
        ...
        protected float decel = 1.2f; // The lower the decel, the slower you slow down
        protected float accel = .78f; // The lower your accel, the slower you take off
        protected float maxSpeed = 5f; // Cannot go faster then this

        const float gravity = 1f;
        const float jumpVelocity = 16f; //How much we can jump
        const float maxFallVelocity = 32; // fastest you can fall
